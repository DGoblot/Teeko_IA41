...
class Ia:
    ...
    def alphaBeta(self, depth, niveau):
        ...
        if tmpGameJ.pions_restant > 0:  # Il y a encore des pions non mis sur le plateau
            ...
            self.GameJ.plateau[meilleur_l][
                meilleur_c] = self.player  # Mettre a jour le plateau par la meilleur position du pion
                    ...
                    if tmpGameJ.plateau[l][c] == self.player:  # Si la position contient le pion de l'ia
                        ...
                        for ad in adjacents:
                            ...
                            if tmpGameJ.moviePionsRobot(l, c, ad[0], ad[1], self.player):
                                ...
                                tmp = self.min(tmpGameJ, niveau, depth - 1, alpha, beta, l,
                    ...
                    if tmpGameJ.plateau[l][
                        ...
                        for ad in adjacents:
                            if tmpGameJ.moviePionsRobot(l, c, ad[0], ad[1],
                                ...
                                print("test")
                                tmp = self.max(tmpGameJ, niveau, depth - 1, alpha, beta, ad[0],
                    ...
                    if tmpGameJ.plateau[l][c] == self.player:  # Si il existe un pion à cette position
                        ...
                        for ad in adjacents:
                            if tmpGameJ.moviePionsRobot(l, c, ad[0], ad[1],
                                ...
                                tmp = self.min(tmpGameJ, niveau, depth - 1, alpha, beta, ad[0],
